...
const ProblemSolution = () => {
  return (
    <section className="bg-[whitesmoke] w-full pt-4 pb-4 lg:pt-5 lg:pb-5 flex items-center justify-center font-main">
      <div className="h-auto grid min-[1450px]:w-[1440px] md:h-[500px] lg:h-[550px] w-[90%] grid-cols-3 grid-rows-5 md:grid-cols-4 md:grid-rows-8 md:gap-3 gap-2">
        ...
        <div className="order-4 h-auto col-span-4 md:col-span-2 md:row-span-2 flex md:justify-start justify-center items-start flex-col">
