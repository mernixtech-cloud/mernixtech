...
const ProblemSolution = () => {
  return (
    <section className="bg-[whitesmoke] md:mt-5 w-full lg:pt-5 lg:pb-5 flex items-center justify-center font-main">
      <div className="h-auto grid min-[1450px]:w-[1440px] md:h-[690px] lg:h-[550px] w-[90%] grid-cols-3 grid-rows-5 md:grid-cols-4 md:grid-rows-8 md:gap-3 gap-2">
        ...
        <div className="h-[250px] order-2 col-span-3 md:col-span-2 md:row-span-7 flex justify-center items-end box1">
          <div className="w-full h-full md:h-auto pt-2 pb-8 pl-3 pr-3 bg-[#000000] opacity-75 text-[#f0f0f5]">
